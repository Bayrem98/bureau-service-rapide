...
const ListSecteurPage = () => {
  ...
  return (
    <>
      <div>
        <div className="secteur-page-section1">
          <div className="d-flex justify-content-between">
            <div>
              <Card className="secteur-page-cards">
                <CardHeader
                  avatar={
                ...
                <CardContent>
                  ...
                  >
                    ...
                    rénovation, à l'entretien et à la gestion des
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  ...
                  >
                    ...
                    mondiale. Ces services englobent un large éventail
                    d'activités allant du transport de marchandises.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
                  <RemoveRedEyeRounded color="primary" />
              ...
              et Bien-etre"
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services liés à la santé et au bien-être englobent un
                    vaste éventail d'activités visant à promouvoir la santé
                    physique, mentale et émotionnelle des individus. Ces
                    services sont axés sur la prévention.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
                  <RemoveRedEyeRounded color="primary" />
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  ...
                  >
                    ...
                    éventail d'activités visant à promouvoir, préserver et
                    enrichir l'expression créative, la diversité culturelle et
                    l'héritage artistique. Ces services contribuent à la vie
                    culturelle.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services liés au droit et aux sciences politiques
                    englobent un ensemble d'activités visant à promouvoir,
                    comprendre et appliquer les principes juridiques et
                    politiques au sein d'une société.
                    <br />
                    <br />
                  </Typography>
                </CardContent>
        ...
        <div className="secteur-page-section2">
          <div className="d-flex justify-content-between">
            <div>
              <Card className="secteur-page-cards">
                <CardHeader
                ...
                <CardContent>
                  ...
                  >
                    ...
                    agricoles, la distribution et la commercialisation des
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services liés à l'hôtellerie et à la restauration
                    englobent un ensemble d'activités visant à offrir des
                    expériences agréables et satisfaisantes aux clients dans le
                    domaine de l'hébergement, de la restauration et des services
                    connexes.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services dans le secteur de l'Industrie, de l'Énergie et
                    de la Production englobent un large éventail d'activités
                    visant à soutenir la fabrication, la production d'énergie et
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services liés à l'enseignement et à la formation
                    englobent un large éventail d'activités visant à transmettre
                    des connaissances, à développer des compétences et à
                    favoriser le développement intellectuel et professionnel des
                    individus.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
              ...
              <Card className="secteur-page-cards">
                ...
                <CardContent>
                  <Typography
                    ...
                    style={{ fontSize: 12 }}
                  >
                    Les services liés à la communication et au multimédia
                    englobent un large éventail d'activités visant à transmettre
                    des informations, à créer du contenu multimédia et à
                    faciliter la diffusion de messages à travers différents
                    canaux.
                  </Typography>
                </CardContent>
                <CardActions disableSpacing>
